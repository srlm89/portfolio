...
public class VirtualMetadataIndexTest {

	@Test
	public void gettingNameFromPath() {
		MetadataIndex index = newIndex();
	...
	public void addingDirectories() {
		VirtualMetadataIndex index = newIndex();
		IndexedDirectory root = index.root();
		...
		IndexedDirectory newDirectory = index.directoryAddIfAbsent("anyDirectory");
	...
	public void addingFiles() {
		...
		IndexedFile newFile = index.singleFileAddIfAbsent("anyFile");
	...
	public void builderTest1() {
		...
		IndexedDirectory builderTest1 = index.root().subDirectory("builder-test-1");
		PathMetadataTest.checkBuilderTest1(builderTest1);
	}

	private VirtualMetadataIndex newIndex() {
		return new VirtualMetadataIndex();
	}
}
