...
import xxl.java.lister.main.lister.RegexFileList;
import xxl.java.lister.metadata.PathMetadata;
import xxl.java.lister.metadata.fs.FileSystemMetadata;
...
public class RegexFileListTest extends TestUtil {
	...
	private RegexFileList newFileLister(String regex, String replacement) {
		...
		PathMetadata metadata = FileSystemMetadata.withRoot(folder);
