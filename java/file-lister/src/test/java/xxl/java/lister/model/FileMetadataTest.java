...
public abstract class FileMetadataTest {

	public static void checkBuilderTest1(FileMetadata builderTest1Metadata) {
		List<SingleFileMetadata> files;
		...
		SingleFileMetadata singleFileMetadata;
	...
	protected SingleFileMetadata newSingleFile(String name, final long size, DirectoryMetadata parent) {
		return new SingleFileMetadata(name, parent) {
			@Override
	...
	protected DirectoryMetadata newDirectory(String name, final Iterable<? extends SingleFileMetadata> files,
