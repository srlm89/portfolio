...
public class SingleFileIterableTest extends TestUtil {

	@Test
	public void cannotRemoveFromIterable() {
		File file1 = resource("DirA/DirC/bottom");
		FileIterable<SingleFileMetadata> iterable = new SingleFileIterable(new File[] { file1 }, null);
		try {
	...
	public void filesSortedInIterable() {
		...
		FileIterable<SingleFileMetadata> iterable = new SingleFileIterable(unordered, null);
		List<SingleFileMetadata> list = toList(iterable);
