...
public class MetadataZipSnapshot implements FileMetadataVisitor<String> {
	...
	*/
	...
	public MetadataZipSnapshot(String snapshotFile, DirectoryMetadata metadata) throws IOException {
	...
	@Override
	public String visitSingleFile(FileMetadata file) {
	...
	private List<String> visitSingleFiles(DirectoryMetadata directory) {
		...
		for (FileMetadata singleFile : directory.files()) {
