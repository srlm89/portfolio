...
import static xxl.java.primitive.EasyString.*;
...
public class EasyStringTest {
	...
	public void maximumLengthOfElementToString() {
		assertEquals(0, longestStringLength(asList(), 0));
		assertEquals(1, longestStringLength(asList("a"), 0));
		assertEquals(1, longestStringLength(asList("a"), 10));
		assertEquals(2, longestStringLength(asList("a", "ab"), 10));
		assertEquals(1, longestStringLength(asList("a", null), 0));
		assertEquals(4, longestStringLength(asList("a", null), 4));
	}
